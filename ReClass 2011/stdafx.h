...
extern vector<MemMapInfo> MemMap;
extern vector<MemMapInfo> MemMapCode;
extern vector<MemMapInfo> MemMapData;
extern vector<MemMapInfo> MemMapModule;

extern vector<AddressName> Exports;
extern vector<AddressName> CustomNames;
